        ...
        <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg p-8">
            ...
            <form method="POST" action="{{ route('users.store') }}">
                ...
                <div class="mb-6">
                    ...
                    <select name="role_id" class="w-full border-gray-300 rounded-lg shadow-sm bg-white text-gray-900 focus:border-primary-blue focus:ring-primary-blue" required>
